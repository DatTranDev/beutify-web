            ...
            <div className="bg-white shadow-md rounded-md p-6 w-full max-w-4xl">
                ...
                {currentPage === 2 && (
                    <div>
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="block font-medium mb-2">
                                    3. Bạn thường sử dụng sản phẩm làm đẹp với mục đích gì?
                                </label>
                ...
                {currentPage === 3 && (
                    <div>
                        ...
                        <div>
                            <label className="block font-medium mb-2">4. Loại da của bạn là gì?</label>
                ...
                {currentPage === 4 && (
                    <div>
                        ...
                        <div>
                            <label className="block font-medium mb-2">
                                5. Bạn thích sản phẩm làm đẹp có mùi hương như thế nào?
                            </label>
